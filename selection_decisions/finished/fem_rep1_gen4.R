...
m <- brm(
  ...
  backend = 'cmdstanr', chains = 12, cores = 12,
  warmup = 2000, iter = 5000, thin = 4,
  control = list(adapt_delta = 0.95, max_treedepth = 12),
  file = 'selection_decisions/models/rep1_gen4.rds'
)
...
if (FALSE) {
  ...
  data.table::fwrite(up_first_picks, 'selection_decisions/fem_rep1_gen4_up_first.csv')
  data.table::fwrite(up_extras, 'selection_decisions/fem_rep1_gen4_up_extras.csv')

  data.table::fwrite(down_first_picks, 'selection_decisions/fem_rep1_gen4_down_first.csv')
  data.table::fwrite(down_extras, 'selection_decisions/fem_rep1_gen4_down_extras.csv')
}
