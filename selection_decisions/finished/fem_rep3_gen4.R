...
m <- brm(
  ...
  file = 'selection_decisions/models/rep3_gen4.rds'
)
#Total execution time: 2.24 days.
summary(m)
pp_check(m, nd = 50)
...
if (FALSE) {
  ...
  data.table::fwrite(up_first_picks, 'selection_decisions/fem_rep3_gen4_up_first.csv')
  data.table::fwrite(up_extras, 'selection_decisions/fem_rep3_gen4_up_extras.csv')

  data.table::fwrite(down_first_picks, 'selection_decisions/fem_rep3_gen4_down_first.csv')
  data.table::fwrite(down_extras, 'selection_decisions/fem_rep3_gen4_down_extras.csv')
}
