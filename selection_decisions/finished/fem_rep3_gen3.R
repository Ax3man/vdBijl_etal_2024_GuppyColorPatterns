...
m <- brm(
  ...
  file = 'selection_decisions/models/rep3_gen3.rds'
)
#Total execution time: 1.38 days.
summary(m)
pp_check(m, nd = 50)
...
if (FALSE) {
  ...
  data.table::fwrite(up_selected_females, 'selection_decisions/fem_rep3_gen3_up.csv')
  data.table::fwrite(down_selected_females, 'selection_decisions/fem_rep3_gen3_down.csv')
}
