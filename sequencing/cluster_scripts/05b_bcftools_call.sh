...
while read name; do
	...
	$bcf mpileup -Ou \
		...
		$bam_list | \
	$bcf call --consensus-caller --variants-only --annotate GQ -Oz -o gwas2/scaffold_vcfs/${name}.vcf.gz &
...
# this parallel approach doesn't work for some reason I can't figure out
#tac reference/scaffolds.list | parallel -j 10 \
#	"$bcf mpileup \
#		-Ou \
#		-r {} \
#		-f reference/GCF_000633615.1/GCF_000633615.1_Guppy_female_1.0_MT_genomic.fna \
#		$bam_list | \
#	$bcf call -cv -Oz -o gwas2/scaffold_vcfs/{}.vcf.gz"
